                ...
                <div class="col-lg-6">
                    ...
                    <form>
                        <div class="row">
                            <div class="col-lg-6">
                                <fieldset>
                                    <input name="name" type="text" id="Username" placeholder="Your name" required>
                                </fieldset>
                            </div>
                            <div class="col-lg-6">
                                <fieldset>
                            ...
                            <div class="col-lg-12">
                                <fieldset>
                                    <button type="button"  class="main-dark-button"><i
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <form id="subscribe" action="{{ url('/subscription-process') }}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-lg-5">
                                <fieldset>
