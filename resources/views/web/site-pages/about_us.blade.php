            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="left-image">
                        <img src="{{ url('/user/assets/images/about-left-image.jpg') }}" alt="">
                    </div>
                </div>
                <div class="col-lg-6">
                ...
                <div class="col-lg-4">
                    <div class="team-item">
                        <div class="thumb">
                            ...
                            <img src="{{ url('/user/assets/images/team-member-01.jpg') }}">
                        </div>
                ...
                <div class="col-lg-4">
                    <div class="team-item">
                        <div class="thumb">
                            ...
                            <img src="{{ url('/user/assets/images/team-member-02.jpg') }}">
                        </div>
                        <div class="down-content">
                            <h4>Ragnar Lodbrok</h4>
                            <span>Product Caretaker</span>
                ...
                <div class="col-lg-4">
                    <div class="team-item">
                        <div class="thumb">
                            ...
                            <img src="{{ url('/user/assets/images/team-member-03.jpg') }}">
                        </div>
                        <div class="down-content">
                            <h4>Ragnar Lodbrok</h4>
                            <span>Product Caretaker</span>
