        ...
        <div class="container">
            <div class="row">
                ...
                <div class="left-images">
                    ...
                    <img src="{{url('/images/'.$img->image ?? '')}}" alt="{{ $product->slug }}" height="300px">
                    ...
                    <div class="quantity-content">
                        ...
                        <div class="right-content">
                            <div class="quantity buttons_added">
                                <button type="button" id="deleteQuantity"   data-id="{{ $product->id }}" class="minus">-</button>
                                <input type="text" id="QuantityInput"  step="1" min="1" max="" name="quantity" value="1" title="Qty" class="input-text qty text" size="4" >
                                <button type="button"  id="addQuantityBtn" data-id="{{ $product->id }}" class="minus">-</button>
                            </div>
                        </div>
                    </div>
                    <div class="total">
