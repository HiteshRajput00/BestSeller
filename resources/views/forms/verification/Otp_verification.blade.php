                        ...
                        <div class="card-body p-md-5">
                            <div class="row justify-content-center">
                                <div class="col-md-12 col-lg-10 col-xl-5 order-2 order-lg-1">
                                    <form class="mx-1 mx-md-4" method="post" action="{{ url('/generate-otp') }}">
                                        @csrf
                                        ...
                                        <div class="d-flex flex-row align-items-center mb-4">
                                            <p>Enter registered Email or Phone number</p>
                                        </div>

                                        <div class="d-flex flex-row align-items-center mb-4">
                                            <div class="form-outline flex-fill mb-0">
                                                <input type="text" id="form3Example3c" name="Otp_verify"
                                                    class="form-control" placeholder="enter email or number" />
                                            </div>
                                        </div>
