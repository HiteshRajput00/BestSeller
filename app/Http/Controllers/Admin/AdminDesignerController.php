...
//::::::::::::::::Approve Designer :::::::::::::::::::::::::::::::::::::::::::::::://
    public function approvedesigner($id){
        ...
        if($user){
            $designer_nf = new DesignerNotification();     // send notification
            $designer_nf->designer_id = $user->id; 
            $designer_nf->title = $user->name;
            $designer_nf->message = " you are approved as designer by admin";
            $designer_nf->save();
        }
        Mail::to($user->email)->send(new designer_mail($maildata));  // mail send to designer
...
//::::::::::::: Approved or disaproved designer list ::::::::::::::::::::::::::::::::::::://
    public function approvedDesignerlist(){
        ...
        if($designer_list->isEmpty()){
            Alert::warning('Sorry', 'You dosen\'t approve any designer yet ')->persistent(true, true);   // sweet alert if not have any approved
            return redirect()->back();
        }
    ...
    public function disapprovedDesignerlist(){
        ...
        if($designer_list->isEmpty()){
            Alert::warning('Sorry', 'You don\'t disapprove any designer yet  ')->persistent(true, true);  // sweet alert if not have any disapproved 
            return redirect()->back();
        }
